          ...
          <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="flex justify-evenly w-full ">
                ...
                <div className="gap-2 flex flex-col items-start text-sm md:text-base ">
                  <span className="flex items-center">
                    <Image src={"/sui-white.png"} width={100} height={30} alt="sui" />
                    <span className="bg-[#030F1C] border border-[#C0E6FF]  text-[#C0E6FF] rounded-lg px-2 h-fit text-base md:text-xl">Testnet Faucet</span>
                  </span>
                  ...
                  <span className="flex text-[#C0E6FF] text-xl space-x-4">
                    ...
                    <Link href={"https://discordapp.com/users/777505954136064001"}> <FaDiscord /></Link>
                    <Link href="https://x.com/0xtitan__"><FaXTwitter /></Link>
                    <Link href="https://github.com/shivareddyVanja/"> <FaGithub /></Link>
                  </span>
                </div>

                <div>
                  <h3 className="font-semibold text-[15px] text-white mb-2 flex items-center  md:gap-2 whitespace-nowrap">

                    Useful Links
                  </h3>
                  <span className=" text-gray-600 space-y-1 flex flex-col text-sm">
                    ...
                    <a href="https://discord.com/invite/sui" className="text-blue-600 hover:underline">Discord</a>
                  </span>
                </div>
              </div>
